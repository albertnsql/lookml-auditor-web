...
def _parse_field(block_text: str, line_num: int, source_file: str) -> Optional[LookMLField]:
    ...
    return LookMLField(
        ...
        sql=sql,
        html=_get_sql_block(block_text, "html") or _get_attr(block_text, "html"),
        value_format=_get_attr(block_text, "value_format"),
        value_format_name=_get_attr(block_text, "value_format_name"),
